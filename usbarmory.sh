#!/bin/bash
# The USB armory MK I is an open source hardware design - http://www.kali.org/downloads
...
extras="alsa-utils bc bison bluez bluez-firmware crda cryptsetup kali-linux-core libnss-systemd libssl-dev lvm2 wpasupplicant"
